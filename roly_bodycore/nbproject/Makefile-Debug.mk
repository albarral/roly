...
OBJECTFILES= \
	...
	${OBJECTDIR}/src/roly/bodycore/BodyTalk.o
...
LDLIBSOPTIONS=-Wl,-rpath,../../tron/tuly/dist/Debug/GNU-Linux -L../../tron/tuly/dist/Debug/GNU-Linux -ltron_tuly -Wl,-rpath,../../tron/talky/dist/Debug/GNU-Linux -L../../tron/talky/dist/Debug/GNU-Linux -ltron_talky
...
${OBJECTDIR}/src/roly/bodycore/BodyBus.o: src/roly/bodycore/BodyBus.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../../tron/tuly/src -I../../tron/talky/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/roly/bodycore/BodyBus.o src/roly/bodycore/BodyBus.cpp

${OBJECTDIR}/src/roly/bodycore/BodyTalk.o: src/roly/bodycore/BodyTalk.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/roly/bodycore
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../../tron/tuly/src -I../../tron/talky/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/roly/bodycore/BodyTalk.o src/roly/bodycore/BodyTalk.cpp
