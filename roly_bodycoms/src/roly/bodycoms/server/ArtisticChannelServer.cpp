...
void ArtisticChannelServer::setTargetModule(int value)
{
    ...
    {
        targetModule = value;
        int channel = (targetModule == BodyConfig::ARTISTIC1) ? BodyNode::eBODY_ARTISTIC1_CHANNEL : BodyNode::eBODY_ARTISTIC2_CHANNEL;
