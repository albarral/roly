...
${OBJECTDIR}/src/roly/interface2/control/ExpressiveServer.o: src/roly/interface2/control/ExpressiveServer.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/roly/interface2/control
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../../tron/tron_coms/src -I../../tron/tron_interface/src -I../../tron/tron_topics/src -I../../tron/tron_util/src -I/usr/include/ignition/transport3 -I/usr/include/ignition/msgs0 -I/usr/include/ignition/math2 -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/roly/interface2/control/ExpressiveServer.o src/roly/interface2/control/ExpressiveServer.cpp
